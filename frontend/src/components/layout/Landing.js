    ...
    <div className="landing-page">
        ...
        <div className="container mx-auto px-4 py-16 text-center md:text-left">
          <div className="md:flex md:items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="font-code text-4xl md:text-5xl font-bold text-white mb-4">Master Coding Challenges</h1>
              <p className="font-code text-xl text-white opacity-90 mb-8">
              ...
              <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-3 sm:space-y-0 sm:space-x-4">
                ...
                <Link 
                  to="/problems"
                  className="font-press btn-outline-primary bg-transparent border-2 px-8 py-3 text-lg font-semibold rounded-md inline-block text-center text-white hover:bg-white hover:text-primary-600"
                >
                  Browse Problems
                </Link>
              </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="font-code text-3xl font-bold text-center mb-12">Why Choose Our Platform?</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="card hover-card p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-code text-xl font-bold mb-3">Diverse Problems</h3>
              <p className="font-code text-gray-600">
            ...
            <div className="card hover-card p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-code text-xl font-bold mb-3">Active Community</h3>
              <p className="font-code text-gray-600">
            ...
            <div className="card hover-card p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-code text-xl font-bold mb-3">Track Progress</h3>
              <p className="font-code text-gray-600">
            ...
            <div className="card hover-card p-6 flex flex-col items-center text-center">
              ...
              <h3 className="font-code text-xl font-bold mb-3">Regular Contests</h3>
              <p className="font-code text-gray-600">
      ...
      <section className="bg-gradient-to-r from-primary-700 to-primary-800 py-16 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="font-code text-3xl font-bold mb-6">Ready to Boost Your Coding Skills?</h2>
          <p className="font-code text-xl mb-8 max-w-3xl mx-auto">
            Join thousands of programmers who are advancing their careers through consistent practice and friendly competition.
          </p>
          <Link 
            to="/register"
            className="font-code bg-white text-primary-700 px-8 py-3 rounded-md text-lg font-semibold hover:bg-gray-100 transition-colors inline-block"
          >
